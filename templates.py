...
templates = ["Protects the right to VERB OBJECTS in PLACE",
              ...
              "Provides the right to ACTION during certain EVENTS",
             ...
             "Limits the powers of the President to ACTION during EVENTS",
             "Prohibits the VERBTGTED of OBJECTS by PEOPLE according to RULESOURCE",
             "Limits the VERBTGTED of the Vice President; the Vice President may not VERB OBJECTS except during EVENTS",
             "Prohibits the VERBTGTED of OBJECTS by the President except during EVENTS",
             ...
             "Prohibits ACTION in PLACE except during EVENTS",
             ...
             "Reinforces the principle of RULESOURCE during EVENTS",
             ...
             "Abolishes ACTION, and ACTION, except as punishment for a crime",
             "Prohibits Congress from ACTION except during EVENTS",
             "Abolishes the VERBTGTED of the President except during EVENTS",
